...
class LabeledExprListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by LabeledExprParser#Modo.
    def enterModo(self, ctx:LabeledExprParser.ModoContext):
        pass

    # Exit a parse tree produced by LabeledExprParser#Modo.
    def exitModo(self, ctx:LabeledExprParser.ModoContext):
        pass
    ...
    # Enter a parse tree produced by LabeledExprParser#Log.
    def enterLog(self, ctx:LabeledExprParser.LogContext):
        pass

    # Exit a parse tree produced by LabeledExprParser#Log.
    def exitLog(self, ctx:LabeledExprParser.LogContext):
        pass
    ...
    # Enter a parse tree produced by LabeledExprParser#Raiz.
    def enterRaiz(self, ctx:LabeledExprParser.RaizContext):
        pass

    # Exit a parse tree produced by LabeledExprParser#Raiz.
    def exitRaiz(self, ctx:LabeledExprParser.RaizContext):
        pass
    ...
    # Enter a parse tree produced by LabeledExprParser#SinCosTan.
    def enterSinCosTan(self, ctx:LabeledExprParser.SinCosTanContext):
        pass

    # Exit a parse tree produced by LabeledExprParser#SinCosTan.
    def exitSinCosTan(self, ctx:LabeledExprParser.SinCosTanContext):
        pass


    # Enter a parse tree produced by LabeledExprParser#Fact.
    def enterFact(self, ctx:LabeledExprParser.FactContext):
        pass

    # Exit a parse tree produced by LabeledExprParser#Fact.
    def exitFact(self, ctx:LabeledExprParser.FactContext):
        pass
