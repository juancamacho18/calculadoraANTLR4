...
public interface LabeledExprVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code Modo}
	 * labeled alternative in {@link LabeledExprParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitModo(LabeledExprParser.ModoContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitRaiz(LabeledExprParser.RaizContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code SinCosTan}
	 * labeled alternative in {@link LabeledExprParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSinCosTan(LabeledExprParser.SinCosTanContext ctx);
	/**
