...
class LabeledExprVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by LabeledExprParser#Modo.
    def visitModo(self, ctx:LabeledExprParser.ModoContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by LabeledExprParser#Raiz.
    def visitRaiz(self, ctx:LabeledExprParser.RaizContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by LabeledExprParser#SinCosTan.
    def visitSinCosTan(self, ctx:LabeledExprParser.SinCosTanContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by LabeledExprParser#Fact.
    def visitFact(self, ctx:LabeledExprParser.FactContext):
        return self.visitChildren(ctx)
